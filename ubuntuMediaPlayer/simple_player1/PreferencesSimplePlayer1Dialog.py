...
class PreferencesSimplePlayer1Dialog(gtk.Dialog):
    __gtype_name__ = "PreferencesSimplePlayer1Dialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesSimplePlayer1Dialog object.
        """
        builder = get_builder('PreferencesSimplePlayer1Dialog')
        new_object = builder.get_object("preferences_simple_player1_dialog")
    ...
    def get_preferences(self):
        """Return a dict of preferences for simple-player1.
...
if __name__ == "__main__":
    dialog = PreferencesSimplePlayer1Dialog()
    dialog.show()
    gtk.main()
