...
def addDirectoryItem(name, label2='', infoType="SoundCloud Music :)", infoLabels={}, isFolder=True, parameters={}):
...
#def stopPlaying():
    ''' Stop playing menu. '''
	#li = xbmcgui.ListItem(label=stop)
    #xbmcplugin.endOfDirectory(handle=handle, succeeded=True)
	
def show_tracks_menu():
    ''' Show the Tracks menu. '''
    addDirectoryItem(name="Most Awesome", parameters={PARAMETER_KEY_URL: PLUGIN_URL + "tracks/hottest", PARAMETER_KEY_MODE: MODE_TRACKS_HOTTEST}, isFolder=True)
...
def show_users_menu():
    ''' Show the Users menu. '''
    addDirectoryItem(name="Most Awesome", parameters={PARAMETER_KEY_URL: PLUGIN_URL + "users/hottest", PARAMETER_KEY_MODE: MODE_USERS_HOTTEST}, isFolder=True)
...
def show_groups_menu():
    ...
    addDirectoryItem(name="Most Awesome", parameters={PARAMETER_KEY_URL: PLUGIN_URL + "groups/hottest", PARAMETER_KEY_MODE: MODE_GROUPS_HOTTEST}, isFolder=True)
...
def show_tracks(tracks, parameters={}):
    ...
    if not len(tracks) < parameters[PARAMETER_KEY_LIMIT]:
        ...
        addDirectoryItem(name="More Stuff xD...", parameters=modified_parameters, isFolder=True)
    xbmcplugin.endOfDirectory(handle=handle, succeeded=True)
...
def show_users(users, parameters):
    ...
    if not len(users) < parameters[PARAMETER_KEY_LIMIT]:
        ...
        addDirectoryItem(name="More Stuff xD...", parameters=more_item_parameters, isFolder=True)
    xbmcplugin.endOfDirectory(handle=handle, succeeded=True)
